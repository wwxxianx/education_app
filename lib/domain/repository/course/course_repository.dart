...
abstract interface class CourseRepository {
  ...
  Future<Either<Failure, List<CourseFAQ>>> updateCourseFAQ(UpdateCourseFAQPayload payload);

  // Voucher
  Future<Either<Failure, List<CourseVoucher>>> getCourseVouchers(String courseId);
  Future<Either<Failure, CourseVoucher>> createCourseVoucher(CreateVoucherPayload payload);
  Future<Either<Failure, UserVoucher>> claimVoucher(ClaimVoucherPayload payload);
}
